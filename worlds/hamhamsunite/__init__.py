from typing import ClassVar, TYPE_CHECKING, cast, Iterable
...
from .client import HamHamsUniteClient # pyright: ignore[reportUnusedImport] # not used, but must be imported
